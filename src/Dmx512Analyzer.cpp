...
Dmx512Analyzer::Dmx512Analyzer() : Analyzer2(), mSettings( new Dmx512AnalyzerSettings() ), mSimulationInitilized( false )
{
...
U32 Dmx512Analyzer::GenerateSimulationData( U64 minimum_sample_index, U32 device_sample_rate,
